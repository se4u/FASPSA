...
Let us first describe how $\hPsi_k$ is computed.
\begin{align}
  \label{eq:PsiHat}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l|ccccc|}
    ...
    A2SPSA     & 0.401   & 1.983   & 0.456   & 0.747   & 3.587 \\
    EA2SPSA    & 0.402   & 1.774   & 0.440   & 0.713   & 3.329 \\
    FA2SPSA    & 0.457   & 3.240   & 0.453   & 0.722   & 4.872 \\
    EFA2SPSA    & 0.333   & 1.759   & 0.436   & 0.709   & 3.237 \\
  \end{tabular}}
