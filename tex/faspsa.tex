...
\begin{table*}
	...
	\\[5pt]
	\caption{Detailed Expressions for Terms in Equation \ref{eq:CoherentRecursion} and Numerber of Floating-Point Operations Required
	\newline
